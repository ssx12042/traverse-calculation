(function ($) {
    $.extend($.validator.messages, {
        ...
        // 2022年5月24日 su添加
        integerVerticalDegree: "请输入一个-90~90的整数",
        integerDegree: "请输入一个0~359的整数",
        integerMinute: "请输入一个0~59的整数",
        doubleSecond: "请输入一个0~60(不包含60)的非负数(小数保留一位小数)",
        double4decimal: "请输入一个非负数(小数最多保留四位小数)"
    });
}(jQuery));
